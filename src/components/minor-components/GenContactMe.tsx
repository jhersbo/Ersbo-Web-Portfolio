...
const GenContactMe = ({ thinScreenBool }: ContactMeProps)=>{
    return(
        <GeneralBubbleComponent thinScreenBool={thinScreenBool} startingCoords={{x: 0, y: thinScreenBool? 120 : 600}} title={"Get in touch"} expandedY={"16vh"} internalJSX={<ContactMeContent thinScreenBool={thinScreenBool}/>}/>
    )
}
